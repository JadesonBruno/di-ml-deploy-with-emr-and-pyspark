...
COPY ./terraform /home/ubuntu/data-projects/di-ml-deploy-with-emr-and-pyspark/terraform
RUN chown -R ubuntu:ubuntu /home/ubuntu/data-projects/di-ml-deploy-with-emr-and-pyspark/terraform

# Switch to ubuntu user
USER ubuntu

# Set the working directory
WORKDIR /home/ubuntu/data-projects/di-ml-deploy-with-emr-and-pyspark/terraform
